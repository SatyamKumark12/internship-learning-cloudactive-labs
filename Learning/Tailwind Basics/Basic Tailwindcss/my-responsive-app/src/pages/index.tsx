...
export default function Home() {
  return (
    ...
    <div className='flex flex-row'>
      <div className='bg-red-300'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Amet molestias corporis soluta praesentium id voluptates ipsam ut possimus repellat facilis repudiandae porro pariatur modi accusantium, dolor quidem neque obcaecati minus ex eius saepe consequatur.</div>

      <div className='bg-green-300'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Amet molestias corporis soluta praesentium id voluptates ipsam ut possimus repellat facilis repudiandae porro pariatur modi accusantium, dolor quidem neque obcaecati minus ex eius saepe consequatur.</div>

    </div>

    <div className='flex flex-row'>
    <div className='bg-yellow-300'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Amet molestias corporis soluta praesentium id voluptates ipsam ut possimus repellat facilis repudiandae porro pariatur modi accusantium, dolor quidem neque obcaecati minus ex eius saepe consequatur.</div>

<div className='bg-blue-300'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Amet molestias corporis soluta praesentium id voluptates ipsam ut possimus repellat facilis repudiandae porro pariatur modi accusantium, dolor quidem neque obcaecati minus ex eius saepe consequatur.</div>
    </div>
